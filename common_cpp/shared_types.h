...
struct TSubmited{
   int id_sbm; //код участника
   int id_publ; //публичный код участника
   ...
   int points; //баллы, которые получило решение (для школьной системы проверки)
   int hardlevel; //баллы - уровень сложности задачи (для ACM'овской системы проверки)
};
