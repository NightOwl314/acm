...
else MessageDlg('Заполните все поля формы!', mtWarning, [mbOk] , 0);
end;
...
data1:='<p>Общее количество задач по теме &quot;'+tema+'&quot; - '+IntToStr(obkolvo)+'</p><p>Количество решенных задач - '+IntToStr(kolvoresh)+'</p><p>Количество нерешенных задач - '+IntToStr(kolvoneresh)+'</p>';
...
MessageDlg('Все данные были добавлены/обновлены!', mtInformation, [mbOk] , 0);
