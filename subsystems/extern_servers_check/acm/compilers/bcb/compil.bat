...
rem если откомпилировалось без ошибок то линкуем
   if not ERRORLEVEL 1 "c:\program files\borland\cbuilder6\bin\ilink32" /S:0x1000000 /Sc:0x1000 /Tpe /ap /c /x /j"c:\program files\borland\cbuilder6\lib" c0x32.obj %1".obj",%1".exe", ,cw32.lib import32.lib
