...
void test3(void)
{
  ...
  BitArray *c;
  {
    BitArray b(a);
    c  = new BitArray(a);
    a.setbit(1, 1-a[1]); a.setbit(2, 1-a[2]); a.setbit(3, 1-a[3]);
    b.setbit(13, 1-b[13]);
    c->setbit(15, 1-(*c)[15]);
...
void test6(void)
{
  ...
  {
    BitArray b(100);
    for (int i=0; i<100; i++) b.setbit(i,1);
    b = a;
    cout << b << endl;
    for (int i=0; i<1000; i++) b.setbit(i,0);
  }
  cout << a << endl; 
}
...
void test8(void)
{
  ...
  if (a!=b) cout << "EQ"; else cout << "NEQ"; cout << endl;
  BitArray c(100);
  for(int i=0; i<100; i++) c.setbit(i,a[i]);
